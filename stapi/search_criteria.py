...
class AstronomicalObjectSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        pageSize,
        sort,
        astronomicalObjectType=None,
        locationUid=None,
        name=None,
    ):
        super(AstronomicalObjectSearchCriteria, self).__init__(
...
class BookSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        anthology=None,
        audiobook=None,
        audiobookAbridged=None,
        audiobookPublishedYearFrom=None,
        audiobookPublishedYearTo=None,
        audiobookRunTimeFrom=None,
        audiobookRunTimeTo=None,
        biographyBook=None,
        eBook=None,
        novel=None,
        novelization=None,
        numberOfPagesFrom=None,
        numberOfPagesTo=None,
        publishedYearFrom=None,
        publishedYearTo=None,
        referenceBook=None,
        rolePlayingBook=None,
        stardateFrom=None,
        stardateTo=None,
        title=None,
        yearFrom=None,
...
class BookSeriesSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        eBookSeries=None,
        miniseries=None,
        numberOfBooksFrom=None,
        numberOfBooksTo=None,
        publishedYearFrom=None,
        publishedYearTo=None,
        title=None,
        yearFrom=None,
...
class ComicSeriesSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        sort,
        miniseries=None,
        numberOfIssuesFrom=None,
        numberOfIssuesTo=None,
...
class EpisodeSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        pageSize,
        sort,
        episodeNumberFrom=None,
        episodeNumberTo=None,
        featureLength=None,
        finalScriptDateFrom=None,
        finalScriptDateTo=None,
        productionSerialNumber=None,
        seasonNumberFrom=None,
        seasonNumberTo=None,
        stardateFrom=None,
        stardateTo=None,
        title=None,
...
class MedicalConditionSearchCriteria(CommonSearchCriteria):
    def __init__(
        self, pageNumber, pageSize, sort, name=None, psychologicalCondition=None
    ):
...
class MovieSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        stardateTo=None,
        title=None,
        usReleaseDateFrom=None,
        usReleaseDateTo=None,
        yearFrom=None,
        yearTo=None,
    ):
...
class SeasonSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        pageSize,
        sort,
        numberOfEpisodesFrom=None,
        numberOfEpisodesTo=None,
        seasonNumberFrom=None,
        seasonNumberTo=None,
        title=None,
    ):
...
class SeriesSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        sort,
        abbreviation=None,
        originalRunEndDateFrom=None,
        originalRunEndDateTo=None,
        originalRunStartDateFrom=None,
        originalRunStartDateTo=None,
        productionEndYearFrom=None,
        productionEndYearTo=None,
        productionStartYearFrom=None,
        productionStartYearTo=None,
        title=None,
    ):
...
class TradingCardSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        sort,
        name=None,
        tradingCardDeckUid=None,
        tradingCardSetUid=None,
    ):
...
class TradingCardSetSearchCriteria(CommonSearchCriteria):
    def __init__(
        ...
        pageSize,
        sort,
        boxesPerCaseFrom=None,
        boxesPerCaseTo=None,
        cardHeightFrom=None,
        cardHeightTo=None,
        cardWidthFrom=None,
        cardWidthTo=None,
        cardsPerPackFrom=None,
        cardsPerPackTo=None,
        name=None,
        packsPerBoxFrom=None,
        packsPerBoxTo=None,
        productionRunFrom=None,
        productionRunTo=None,
        productionRunUnit=None,
        releaseYearFrom=None,
        releaseYearTo=None,
    ):
